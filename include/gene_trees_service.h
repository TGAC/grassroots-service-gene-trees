...
GENE_TREES_SERVICE_PREFIX const char *GTS_CLUSTER_IDS GENE_TREES_SERVICE_VAL ("cluster_id");
 ...
 *
 */
GENE_TREES_SERVICE_API ServicesArray *GetServices (UserDetails *user_p, GrassrootsServer *grassroots_p);
